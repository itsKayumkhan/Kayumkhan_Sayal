export const projectObj = [
  {
    img: "https://res.cloudinary.com/dslgstzex/image/upload/v1723643872/movieInfo_ybm31d.png",
...
export const serviceObj = [
  {
    ...
    title: "Photo Editing",
    description:
      "Professional photo editing services to enhance and transform your images. From color correction to retouching, get stunning visuals for any purpose.",
  },
  {
    icon: "icofont-chart-bar-graph",
    title: "Social Adviser",
    description:
      "Expert social advising to help you navigate the complexities of social media and online presence. Improve your engagement and reach with tailored strategies.",
  },
  {
    icon: "icofont-earth",
    title: "Web Designer",
    description:
      "Creating visually captivating and user-friendly websites. Specializing in  JavaScript to deliver designs that effectively  engage your audience.",
  },
  {
    icon: "icofont-image",
    title: "Photographer",
    description:
      "Capturing moments with professional photography services. Whether for events, portraits, or products, achieve high-quality images that tell a story.",
  },
  {
    icon: "icofont-settings",
    title: "Software Engineer",
    description:
      "Developing robust and scalable software solutions. Expertise in various programming languages and frameworks to build applications that meet your needs.",
  },
  {
    icon: "icofont-contact-add",
    title: "Contact",
    description:
