  ...
  return (
    <ContainerWrapper>
      <>
        ...
        <section
          id="Contact"
          className=" py-12 bg-cover bg-no-repeat bg-[url('..../public/pexels-vlado-paunovic-1567547-3038740.jpg')]"
        >
          {" "}
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-24">
              ...
              <div className="lg:max-w-xl w-full h-[600px] flex items-center justify-center  relative ">
                <div className=" relative  rounded-xl">
                  <div className="lg:w-96 w-auto h-auto  shadow-xl lg:p-6 p-4  rounded-xl">
