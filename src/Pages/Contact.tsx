...
const Contact = () => {
  ...
  return (
    <ContainerWrapper>
      <section className="py-12 bg-cover bg-no-repeat bg-[url('..../public/assets/pexels-vlado-paunovic-1567547-3038740.jpg')]">
        {" "}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-24">
            <div className="flex items-center lg:mb-0 mb-10 bg-white p-12  relative bg-custom">
              <div>
            ...
            <div className="lg:max-w-xl w-full h-[600px] flex items-center justify-center  relative ">
