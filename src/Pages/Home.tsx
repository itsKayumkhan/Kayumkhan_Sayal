    ...
    <>
      <main className=" h-[90vh] ms-36 relative  top-20">
        ...
        <div className="flex flex-col  items-start gap-2 z-10 top-2">
          <h1 className="text-7xl font-bold z-10 shadow-white">Kayumkhan_Sayal</h1>
          <h2 className="text-3xl mt-4">Full Stack Developer</h2>
          <div>
            <Button
              text="Resume"
        ...
        <div className="img absolute -top-32 left-[30%] -z-1">
          <img src={gLogo} alt="gLogo" className="-z-1" />
        </div>
